...
serve(async (req) => {
  ...
  try {
    ...
    // Fetch all processing orders without pagination
    let query = supabaseAdmin
      ...
      .select(`
        ...
        product_id, products (name), profiles (first_name, last_name, phone), user_id, type, comment, ordered_design_data
      `)
    ...
    console.error("Edge Function Error (get-processing-orders):", error);
