...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Categories', href: '/admin/products', icon: Package }, // Renamed from Products to Categories
    { name: 'All Products', href: '/admin/all-products', icon: Boxes }, // New item
    { name: 'Orders', href: '/admin/orders', icon: ShoppingCart },
    { name: 'Processed by User', href: '/admin/processed-orders-by-user', icon: ListChecks }, // Updated href
    { name: 'All Processing', href: '/admin/all-processing-orders', icon: ClipboardList },
