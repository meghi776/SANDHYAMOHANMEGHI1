...
const UserManagementPage = () => {
  ...
  const fetchProfiles = async () => {
    ...
    try {
      ...
      if (getSessionError) {
        console.error("UserManagementPage: Error getting session before invoke:", getSessionError);
        throw new Error("Failed to get current session. Please try logging in again.");
      }
      ...
      // Call the new Edge Function to get all users with their emails
      ...
      if (invokeError) {
        console.error("Edge Function Invoke Error (get-all-users):", invokeError);
        ...
        throw new Error("Unexpected response from server when fetching users.");
      }
    } catch (err: any) {
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Email</TableHead> {/* New TableHead for Email */}
                  ...
                  <TableBody>
                    {profiles.map((profile) => (
                      <TableRow key={profile.id}>
                        ...
                        <TableCell>{profile.email || 'N/A'}</TableCell> {/* Display Email */}
